    ...
    const onParse = (event: ParsedEvent | ReconnectInterval) => {
      if (event.type === "event") {
        ...
        try {
          ...
          text = text.replace(/```(jsx|tsx|typescript|javascript)?\n?/, "");
          text = text.replace(/```\s*$/, "");
          setGeneratedCode((prev) => prev + text);
        } catch (e) {
          console.error(e);
                      ...
                      {[
                        ...
                        >
                          ...
                          <Select.ItemIndicator className="ml-auto">
                            <CheckIcon className="size-5 text-neon-pink" />
                    ...
                    <div className="relative flex rounded-3xl bg-white shadow-sm group-disabled:bg-gray-50">
                      <div className="relative flex flex-grow items-stretch focus-within:z-10">
                        <input
                          required
                          name="prompt"
                          className="w-full rounded-l-3xl bg-transparent px-6 py-5 text-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-neon-pink disabled:cursor-not-allowed"
                  ...
                  <Tooltip.Root delayDuration={0}>
                    <Tooltip.Trigger asChild>
                      <button
                        ...
                        className="inline-flex size-[68px] items-center justify-center rounded-3xl bg-neon-pink"
                      >
